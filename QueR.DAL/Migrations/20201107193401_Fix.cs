        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QueueTypes_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Queues_QueueTypes_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(nullable: true),
                    WorksiteId = table.Column<int>(nullable: true),
                    AssignedQueueId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Queues_AssignedQueueId",
                        column: x => x.AssignedQueueId,
                        principalTable: "Queues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Sites_WorksiteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AssignedQueueId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_WorksiteId",
                table: "AspNetUsers",
                column: "WorksiteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Queues_SiteId",
                table: "Queues",
                column: "SiteId");

            migrationBuilder.CreateIndex(
                name: "IX_Queues_TypeId",
                table: "Queues",
                column: "TypeId");

            migrationBuilder.CreateIndex(
                name: "IX_QueueTypes_CompanyId",
                table: "QueueTypes",
                column: "CompanyId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Companies_AspNetUsers_AdministratorId",
                table: "Companies",
                column: "AdministratorId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
